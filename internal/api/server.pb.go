...
type RegisterResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        uint64                 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // User ID of the registered user.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_server_proto_rawDesc = "" +
	...
	"\x05Login\x12\x11.api.LoginRequest\x1a\x12.api.LoginResponseB\x10Z\x0e./internal/apib\x06proto3"
...
var file_server_proto_depIdxs = []int32{
	0, // 0: api.GophKeeper.Register:input_type -> api.RegisterRequest
	2, // 1: api.GophKeeper.Login:input_type -> api.LoginRequest
	1, // 2: api.GophKeeper.Register:output_type -> api.RegisterResponse
	3, // 3: api.GophKeeper.Login:output_type -> api.LoginResponse
